...
public class StatistikaMainController implements Initializable {
    ...
    private void OpenGeneral(ActionEvent event) throws IOException{
        ...
        sl.StageLoad("/sopho/Eidi/GeneralStatistika.fxml", stage, true, false); //resizable true, utility false
    }
    
    @FXML
    private void OpenFilters(ActionEvent event) throws IOException{
        Stage stage = (Stage) backButton.getScene().getWindow();
        sl.StageLoad("/sopho/Eidi/FiltersStatistika.fxml", stage, true, false); //resizable true, utility false
    }
